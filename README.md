...
| `hooks/vendored-skill-nudge.sh` | PreToolUse(Skill): nudges on handoff, to-tickets, research skills that records live in issues |
| `docs/incidents.md` | One paragraph per incident behind a rule, cited by slug from the skills |
