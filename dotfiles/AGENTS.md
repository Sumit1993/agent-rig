...
- **No fixed lane cap.** Run as wide as the work allows; any real limit is named per-run from whatever is actually scarce (a shared review counter, a serialising merge invariant) — see the **`nightly-run`** skill §2.
