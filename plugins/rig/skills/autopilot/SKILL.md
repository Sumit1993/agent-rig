...
- A session that cannot merge with the operator present does not merge at all. Take the PR to green, mark it ready, leave it; the review queue merges it once its review comes back clean (§10).
